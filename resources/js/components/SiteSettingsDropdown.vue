      ...
      <MenuItems as="div" style="min-width: 250px;" class="dropdown">
        <div class="py-2">
          ...
          <button :class="[active ? 'active' : '']"
            @click.stop.prevent="logViewerStore.shorterStackTraces = !logViewerStore.shorterStackTraces">
          ...
          <button :class="[active ? 'active' : '']">
            ...
            <span v-show="!fileStore.cacheRecentlyCleared['*'] && !fileStore.clearingCache['*']">Clear indices for all
              files</span>
